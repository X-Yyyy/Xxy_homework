...
from LeNet_improve import MultiRF2_Net
from models import C3D, LeNet
import math
import time
...
parser.add_argument('--n_classes', type=int, default=12,
                    help='number of frames per input')
# parser.add_argument('--model', type=str,default="LeNet") #LeNet # MultiRF2_Net
# parser.add_argument('--model_path', type=str,default=r"D:\PyCharmresorce\PycharmProjects\learn_pytorch\Xxy_Github_homework\weights\gesture_recog_weights\LeNet_rgb_prova\best_val_acc_checkpoint_LeNet_rgb_prova.pth.tar")
parser.add_argument('--model', type=str,default="MultiRF2_Net") #LeNet # MultiRF2_Net
parser.add_argument('--model_path', type=str,default=r"D:\PyCharmresorce\PycharmProjects\learn_pytorch\gestures_recog_MultiRF2\weights\gesture_recog_weights\MultiRF2_Net_rgb_prova\best_val_acc_checkpoint_MultiRF2_Net_rgb_prova.pth.tar")
# CrossConvNet
...
parser.add_argument('--exp_result_dir', type=str, default="exp_results_test")
...
class GestureTestSet(Dataset):
    def __init__(self, csv_test_path, mode='rgb', normalization_type=-1,
        ...
        with open(self.csv_path, 'r') as csv_in:
            ...
            print(len(self.list_of_rows_with_same_mode[2]))
            csv_in.seek(0)
...
def main():
    ...
    print(args.mode)
    test_set = GestureTestSet(csv_test_path='./csv_test_dataset_rgb_mini.txt', n_frames=args.n_frames, resize_dim=args.input_size,
